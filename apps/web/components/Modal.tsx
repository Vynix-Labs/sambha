  ...
  return (
    ...
    >
      <DialogContent
        ...
        className={`max-h-[calc(100vh-2rem)] outline-none overflow-y-auto thin-scrollbar max-md:w-sm rounded-[20px] lg:max-w-${size} md:max-w-md bg-white text-black bg-[#FFFFFF]
        `}
      >
        <DialogClose asChild>
          <button
